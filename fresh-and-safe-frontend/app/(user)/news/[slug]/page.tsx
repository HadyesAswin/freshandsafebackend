  ...
  if (error || !article) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
        ...
        <button onClick={() => router.push("/news")} className="px-6 py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700">
          Back to News
        </button>
      </div>
    );
    ...
    <main className="min-h-screen bg-gray-50 pb-20 font-sans">
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link href="/news" className="text-sm font-bold text-gray-500 hover:text-green-600 transition-colors flex items-center gap-1">
