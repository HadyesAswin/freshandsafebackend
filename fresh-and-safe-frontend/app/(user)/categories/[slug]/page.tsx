            ...
            return (
              <div key={product.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative">
                ...
                <div className="p-5">
                  ...
                  <button onClick={() => router.push(`/product/${product.slug}`)} className="w-full py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 active:scale-95 transition-all shadow-md text-sm">
                    View Details
                  </button>
                </div>
              </div>
