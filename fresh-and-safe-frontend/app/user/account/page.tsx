    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-64 bg-white rounded-xl shadow-sm border p-6 space-y-2 h-fit">
          ...
          <button onClick={() => router.push("/user/wishlist")} className="block w-full text-left px-4 py-3 rounded-lg font-semibold transition-colors text-gray-600 hover:bg-gray-50">
            My Wishlist
          </button>
                        ...
                        return (
                          <tr key={order.id} className="border-b hover:bg-gray-50 transition-colors text-sm">
                            ...
                            <td className="p-4 text-right">
                              <Link href={`/user/order/${order.order_number}`} className="bg-green-100 text-green-700 px-4 py-2 rounded-lg font-bold text-xs hover:bg-green-200 transition">View Details</Link>
                            </td>
                          </tr>
                        );
                      })}
