      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="bg-white p-10 rounded-2xl border text-center shadow-sm">
            <p className="text-gray-500 font-medium">Privacy policy details are currently unavailable.</p>
          </div>
        ) : (
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
            {/* Show the most recent update date based on the first section returned */}
