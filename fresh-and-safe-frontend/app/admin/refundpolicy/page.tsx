...
import { Plus, Pencil, Trash2, Undo2, FileText } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage return and refund guidelines for your customers.</p>
        </div>
              ...
              {policies.length > 0 ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center">
                    ...
                    <p className="text-sm text-gray-500 font-medium">No refund policies added yet.</p>
                  </td>
                </tr>
              )}
            </tbody>
