      ...
      <div className="flex items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Update your outlet password and secure your account.
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 mt-6 border-t border-gray-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-2 px-8 py-2.5 bg-red-600 text-white rounded-lg font-bold text-sm hover:bg-red-700 shadow-sm transition-all active:scale-[0.98] disabled:opacity-50 min-w-[180px] justify-center"
            >
              {loading ? (
